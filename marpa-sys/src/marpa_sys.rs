...
#[derive(Copy, Clone)] pub enum MarpaGrammar {}
#[derive(Copy, Clone)] pub enum MarpaRecce {}
#[derive(Copy, Clone)] pub enum MarpaBocage {}
#[derive(Copy, Clone)] pub enum MarpaOrder {}
#[derive(Copy, Clone)] pub enum MarpaTree {}
